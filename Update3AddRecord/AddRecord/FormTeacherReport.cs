    ...
    public partial class FormTeacherReport : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string register = "insert into TeacherReport (Name,Surname,Lessons,IsActive,IsDeleted) values(@Name,@Surname,@Lessons,@IsActive,@IsDeleted)";
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView2.SelectedRows.Count > 0)
                {
                    ...
                    string updateQuery = "UPDATE TeacherReport SET Name = @Name, Surname = @Surname, Lessons = @Lessons, IsActive = @IsActive, IsDeleted = @IsDeleted WHERE TeacherID = @TeacherID";
