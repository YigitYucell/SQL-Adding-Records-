    ...
    public partial class FormTeacher : Form 
    {
        ...
        private void button_save2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string register = "insert into Teacher (Name,Surname,TCNO,BirthDate,PhoneNo,Degree,City,Salary,IsActive,IsDeleted) values(@Name,@Surname,@TCNO,@BirthDate,@PhoneNo,@Degree,@City,@Salary,@IsActive,@IsDeleted)";
        ...
        private void dataGridView2_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            comboBox2.Text = dataGridView2.CurrentRow.Cells[9].Value.ToString();
            comboBox1.Text = dataGridView2.CurrentRow.Cells[10].Value.ToString();
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView2.SelectedRows.Count > 0)
                {
                    ...
                    int selectedTeacherID = Convert.ToInt32(selectedRow.Cells["TeacherID"].Selected); 

                    string updateQuery = "UPDATE Teacher SET Name = @Name, Surname = @Surname, TCNO = @TCNO, BirthDate = @BirthDate, PhoneNo = @PhoneNo, Degree = @Degree, City = @City, Salary = @Salary,IsActive = @IsActive, IsDeleted = @IsDeleted WHERE TeacherID = @TeacherID";
            ...
            if (dataGridView2.SelectedRows.Count > 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string deactivateQuery = "UPDATE Teacher SET IsActive = @IsActive WHERE TeacherID = @TeacherID";
                        ...
                        string deleteQuery = "UPDATE Teacher SET IsDeleted = @IsDeleted WHERE TeacherID = @TeacherID";
