    ...
    public partial class FormStudentReport : Form
    {
        ...
        private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string register = "insert into StudentReport (Name,Surname,Lessons,CreatedUserName,ModifiedUserName,CreatedTime,ModifiedTime) values(@Name,@Surname,@Lessons,@CreatedUserName,@ModifiedUserName,@CreatedTime,@ModifiedTime)";
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    string updateQuery = "UPDATE StudentReport SET Name = @Name, Surname = @Surname, Lessons = @Lessons WHERE StudentID = @StudentID";
