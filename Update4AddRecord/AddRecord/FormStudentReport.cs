    ...
    public partial class FormStudentReport : Form
    {
        ...
        /*private void button_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string register = "insert into Student (Name,Surname,Lessons,IsActive,IsDeleted) values(@Name,@Surname,@Lessons,@IsActive,@IsDeleted)";
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    string updateQuery = "UPDATE Student SET Name = @Name, Surname = @Surname, Lessons = @Lessons, IsActive = @IsActive, IsDeleted = @IsDeleted WHERE StudentID = @StudentID";
